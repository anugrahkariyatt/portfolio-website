...
const TiltCard = ({ children, className = "", tiltDegree = 12 }) => {
  ...
  return (
    <motion.div
      ...
      className={`relative rounded-2xl glass-card glass-card-hover overflow-hidden transition-colors duration-300 ${className}`}
    >
